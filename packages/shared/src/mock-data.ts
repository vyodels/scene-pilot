...
export const mockSkills: SkillRecord[] = [
  {
    ...
    skillId: "site_initial_screening",
    name: "Recruiting Scene Screening",
    version: "1.2.0",
    status: "active",
    platform: "site",
  ...
  },
  {
    ...
    skillId: "site_followup_sequence",
    name: "Recruiting Scene Follow-up",
    version: "0.3.0",
...
export const mockApprovals: ApprovalRecord[] = [
  {
    ...
    createdAt: now,
    requestedBy: "agent",
    summary: "New selector fallback path discovered after the recruiting scene layout changed.",
  },
  {
    id: "approval_002",
